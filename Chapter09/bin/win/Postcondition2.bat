...
"%JAVA_HOME%\bin\java" -classpath "classes;src;%JBOSSAOP_HOME%\jboss-aop.jar;%JBOSSAOP_HOME%\javassist.jar;%JBOSSAOP_HOME%\jboss-common.jar;%JBOSSAOP_HOME%\trove.jar;%CLASSPATH%" -Djava.system.class.loader=org.jboss.aop.standalone.SystemClassLoader aop.contracts.postconditions.PostConditionExample2
