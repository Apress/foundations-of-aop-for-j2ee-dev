...
"%JAVA_HOME%\bin\javac" -classpath "%JBOSSAOP_HOME%\jboss-aop.jar;%JBOSSAOP_HOME%\javassist.jar;%JBOSSAOP_HOME%\jboss-common.jar;%JBOSSAOP_HOME%\trove.jar;%JBOSSAOP_HOME%\concurrent.jar;%CLASSPATH%" -d classes src\aop\tests\cover\*.java

echo ---- Execution ----

"%JAVA_HOME%\bin\java" -classpath "classes;src;%JBOSSAOP_HOME%\jboss-aop.jar;%JBOSSAOP_HOME%\javassist.jar;%JBOSSAOP_HOME%\jboss-common.jar;%JBOSSAOP_HOME%\trove.jar;%JBOSSAOP_HOME%\concurrent.jar;%CLASSPATH%" -Djava.system.class.loader=org.jboss.aop.standalone.SystemClassLoader aop.tests.cover.CoverExample
