...
echo ------------------------------------------------------
echo - Application: ObserverExample                       -
echo - Aspect:      Observer                              -
echo ------------------------------------------------------
...
"%JAVA_HOME%\bin\java" -classpath "..\..\classes;%ASPECTJ_HOME%\lib\aspectjrt.jar;%CLASSPATH%" aop.patterns.observer.ObserverExample
