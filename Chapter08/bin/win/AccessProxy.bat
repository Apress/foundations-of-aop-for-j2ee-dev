...
echo ------------------------------------------------------
echo - Application: AccessProxyExample                    -
...
"%JAVA_HOME%\bin\java" -classpath "..\..\classes;%ASPECTJ_HOME%\lib\aspectjrt.jar;%CLASSPATH%" aop.patterns.accessproxy.ProxyExample %*
