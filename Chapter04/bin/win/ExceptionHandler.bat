...
echo - Aspect:      Introducing an exception handler           -
echo -----------------------------------------------------------
...
"%JAVA_HOME%\bin\java" -classpath "classes;%JAC_HOME%\jac.jar;%CLASSPATH%" org.objectweb.jac.core.Jac -R . -C classes;src exceptionhandler.jac
