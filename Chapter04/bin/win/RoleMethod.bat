...
echo -----------------------------------------------------------------
echo - Application: Exception generator                              -
echo - Aspect:      Introducing the computeAmountAndPrint method     -
echo -----------------------------------------------------------------
...
"%JAVA_HOME%\bin\java" -classpath "classes;%JAC_HOME%\jac.jar;%CLASSPATH%" org.objectweb.jac.core.Jac -R . -C classes;src rolemethod.jac
