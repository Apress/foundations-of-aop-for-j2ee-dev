...
"%JAVA_HOME%\bin\java" -classpath "%ASPECTJ_HOME%\lib\aspectjtools.jar;%ASPECTJ_HOME%\lib\aspectjrt.jar;%CLASSPATH%" org.aspectj.tools.ajc.Main -d ..\..\classes @..\..\default2.lst
